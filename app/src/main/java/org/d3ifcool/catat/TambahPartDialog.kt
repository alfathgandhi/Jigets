    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val watcher = object :  TextWatcher{
            ...
            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                val plane = viewe.findViewById<EditText>(R.id.et_plane).text.toString().trim()
                val namaPart = viewe.findViewById<EditText>(R.id.et_namaPart).text.toString().trim()
                val basic = viewe.findViewById<EditText>(R.id.et_basic).text.toString().trim()
                val keterangan = viewe.findViewById<EditText>(R.id.et_keterangan).text.toString().trim()
                val line = viewe.findViewById<EditText>(R.id.et_line).text.toString().trim()
                val namaType = viewe.findViewById<EditText>(R.id.et_part_type).text.toString().trim()



               alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).isEnabled = !(plane.isEmpty()||boolean==false||namaPart.isEmpty()||basic.isEmpty()||line.isEmpty()||namaType.isEmpty())
       ...
       alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).isEnabled = false
        ...
        viewe.findViewById<EditText>(R.id.et_plane).addTextChangedListener(watcher)
         viewe.findViewById<EditText>(R.id.et_namaPart).addTextChangedListener(watcher)
          viewe.findViewById<EditText>(R.id.et_basic).addTextChangedListener(watcher)

          viewe.findViewById<EditText>(R.id.et_line).addTextChangedListener(watcher)
...
//        }
    ...
    private fun getData(view: View):List<String>?{
        ...
        val plane = view.findViewById<EditText>(R.id.et_plane).text.toString()
        ...
        val keterangan = view.findViewById<EditText>(R.id.et_keterangan).text.toString()
        val line = view.findViewById<EditText>(R.id.et_line).text.toString()
        ...
        if(plane.isEmpty()||boolean==false||namaPart.isEmpty()||basic.isEmpty()||line.isEmpty()||namaType.isEmpty()){
            showMessage(R.string.field)

            return null

        }else{
            return  listOf(plane,gambar!!,namaPart,basic,keterangan,line)
        }
